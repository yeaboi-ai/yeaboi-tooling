...
Arguments (optional): the user’s arguments — a slug for the clip, or a sentence describing what to show. With
...
**Read `.agents/repo-notes.md` first.** Its `## Clips` section carries the facts this command
